This is a simple python script I wrote to convert Japanese audio into a transcript for studying the language. I've put it here on GitHub in case anyone else would like to use it.
